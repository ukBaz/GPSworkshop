...
class IPD:
  ...
  def __init__(self):
    ...
    self.scrollSpeed = 25
    self.toDisp = 0b01000000, 0b01000000, 0b01000000, 0b01000000
  ...
  def setClock(self, value):
    ...
    self.toDisp = int(self.digits2[value[0]] | 0b10000000), int(self.digits2[value[1]] | 0b10000000), int(self.digits2[value[2]]), int(self.digits2[value[3]])
      ...
      if len(self.toDisp) == 4:
        ...
        for i in range(0, len(padString)-3):
          for s in range(0, self.scrollSpeed):
            loc1 = int(self.digits2[padString[i]])
            loc2 = int(self.digits2[padString[(i + 1)]])
            loc3 = int(self.digits2[padString[(i + 2)]])
            loc4 = int(self.digits2[padString[(i + 3)]])
